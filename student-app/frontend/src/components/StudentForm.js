...
export default function StudentForm() {
  ...
  const [form, setForm] = useState({ rollNumber: "", name: "", branch: "", email: "", phone: "", semester: "" });
  ...
  const handleSubmit = async () => {
    if (!form.rollNumber || !form.name || !form.branch || !form.email) return alert("RollNumber, Name, Branch, Email required");
    try {
